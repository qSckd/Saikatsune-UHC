            ...
            if(material == Material.getMaterial(38) || material == Material.YELLOW_FLOWER || material == Material.CROPS ||
                ...
                if(!toDrop.equals(new ItemStack(Material.AIR))) {
                    if(!toDrop.equals(new ItemStack(Material.BEDROCK))) {
                        if (!toDrop.equals(new ItemStack(Material.COMMAND))) {
                            if (!toDrop.equals(new ItemStack(Material.IRON_DOOR)) || (!toDrop.equals(new ItemStack(Material.WOOD_DOOR)) || (!toDrop.equals(new ItemStack(Material.WOODEN_DOOR))))) {
